...
2.24 Click on “Continue” button
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        laptopsAndNotebooksPage.enterName("Bhavesh");
        laptopsAndNotebooksPage.enterLastName("Jani");
        ...
        laptopsAndNotebooksPage.enterAddress("2,kenton road");
        laptopsAndNotebooksPage.enterCity("Harrow");
        laptopsAndNotebooksPage.enterPostcode("HA8 5NN");
        laptopsAndNotebooksPage.enterCountry("London");
